...
#define VIDEOBASE      (u16*)0x6000000
...
#define DMAC_BASE	0x4000000						// DMA Base Address

#define DMA0SAD		*(u32*)(DMAC_BASE + 0xB0)		// DMA0 Source Address
#define DMA0DAD		*(u32*)(DMAC_BASE + 0xB4)		// DMA0 Destination Address
#define DMA0CNT		*(u32*)(DMAC_BASE + 0xB8)		// DMA0 Length Counter

// DMA1 Registers
#define DMA1SAD		*(u32*)(DMAC_BASE + 0xBC)		// DMA1 Source Address
#define DMA1DAD		*(u32*)(DMAC_BASE + 0xC0)		// DMA1 Destination Address
#define DMA1CNT		*(u32*)(DMAC_BASE + 0xC4)		// DMA1 Length Counter

// DMA2 Registers
#define DMA2SAD		*(u32*)(DMAC_BASE + 0xC8)		// DMA2 Source Address
#define DMA2DAD		*(u32*)(DMAC_BASE + 0xCC)		// DMA2 Destination Address
#define DMA2CNT		*(u32*)(DMAC_BASE + 0xD0)		// DMA2 Length Counter
...
// General DMA Flags
#define DMACNT_ENABLE		( (1 << 31)&(0x80000000) )		// Enable DMA operation
#define DMACNT_INCDEST		(0)								// Increment Destination after copy
#define DMACNT_DECDEST		( (1 << 21)&(0x200000) )		// Decrement Destination after copy
#define DMACNT_FIXDEST		( (1 << 22)&(0x400000) )		// Leave Destination unchanged after copy
#define DMACNT_INCSRC		(0)								// Increment Source after copy
#define DMACNT_DECSRC		( (1 << 23)&(0x800000) )		// Decrement Source after copy
#define DMACNT_FIXSRC			( (1 << 24)&(0x1000000) )		// Leave Source unchanged after copy
#define DMACNT_32BIT		( (1 << 26)&(0x4000000) )		// Copy 32 bits at a time
#define DMACNT_16BIT		(0)								// Copy 16 bits at a time
#define DMAVBLANK
